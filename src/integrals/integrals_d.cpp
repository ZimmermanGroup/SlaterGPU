...
void gather_125_d_En(int s1, int s2, int gs, int iN, float** valt1, float** valt2, float** valS1, float** valS2, float** valS5, float** valtx1, float** valtx2, float** valS1x, float** valS2x, float** valS5x, float* wtt1, float* wtt2, float* wt3)
{
  int gs3 = 3*gs;
...
void gather_125_d_En_2(int s1, int s2, int gs, int iN, float** valtx1, float** valtx2, float** valtx3, float** valS1, float** valS2, float** valS5, float* wtt1, float* wtt2, float* wt3)
{
  int gs3 = 3*gs;
...
#else
void compute_d_3c_para(int npgu, int natoms, int* atno, float* coords, vector<vector<double> > &basis, vector<vector<double> > &basis_aux, int nrad, int nang, double* ang_g0, double* ang_w0, double* dC, float* xyz_grad, int prl)
#endif
{
 #if !USE_ACC
 ...
 //CPMZ this function not done
  ...
  double* norms2 = new double[N2];
  for (int i=0;i<N;i++)
  for (int j=0;j<N;j++)
    norms2[i*N+j] = basis[i][4]*basis[j][4];
  double* norms1 = new double[Naux];
  ...
  float** val1x = new float*[iNa];
  float** val2x = new float*[iN];
  float** val3x = new float*[iN];
  float** val4x = new float*[iNa];
  float** val5x = new float*[iN];
  float** val6x = new float*[iN];
  float** val7x = new float*[iNa];
  float** val8x = new float*[iN];
  float** val9x = new float*[iN];

  for (int i=0;i<iNa;i++) val1x[i] = new float[gs3];
  for (int i=0;i<iN;i++)  val2x[i] = new float[gs3];
  for (int i=0;i<iN;i++)  val3x[i] = new float[gs3];
  for (int i=0;i<iNa;i++) val4x[i] = new float[gs3];
  for (int i=0;i<iN;i++)  val5x[i] = new float[gs3];
  for (int i=0;i<iN;i++)  val6x[i] = new float[gs3];
  for (int i=0;i<iNa;i++) val7x[i] = new float[gs3];
  for (int i=0;i<iN;i++)  val8x[i] = new float[gs3];
  for (int i=0;i<iN;i++)  val9x[i] = new float[gs3];

  float* valt1 = new float[gs3];
  float* valt2 = new float[gs3];
...
#endif
{
 ...
 //no <pVp> terms
  ...
  float** valS1x = new float*[iN]; for (int i=0;i<iN;i++) valS1x[i] = new float[gs3];
  float** valS2x = new float*[iN]; for (int i=0;i<iN;i++) valS2x[i] = new float[gs3];
  float** valS3x = new float*[iN]; for (int i=0;i<iN;i++) valS3x[i] = new float[gs3];
  float** valS4x = new float*[iN]; for (int i=0;i<iN;i++) valS4x[i] = new float[gs3];
  float** valS5x = new float*[iN]; for (int i=0;i<iN;i++) valS5x[i] = new float[gs3];
  float** valS6x = new float*[iN]; for (int i=0;i<iN;i++) valS6x[i] = new float[gs3];
  ...
  float** valtx1 = new float*[iN]; for (int i=0;i<iN;i++) valtx1[i] = new float[gs3];
  float** valtx2 = new float*[iN]; for (int i=0;i<iN;i++) valtx2[i] = new float[gs3];
  float** valtx3 = new float*[iN]; for (int i=0;i<iN;i++) valtx3[i] = new float[gs3];
   ...
   //two-center basis
    ...
    if (m!=n)
    {
     ...
     #pragma acc parallel loop present(grid1[0:gs6],grid2[0:gs6],valtx1[0:iN][0:gs3],valtx2[0:iN][0:gs3])
      for (int j=0;j<gs;j++)
      {
        //float Rn2a = grid1s[6*j+3]; float Rn2b = grid2s[6*j+3];
     ...
     #pragma acc parallel loop present(grid1[0:gs6],grid2[0:gs6],valt1[0:iN][0:gs],valt2[0:iN][0:gs],valtx1[0:iN][0:gs3],valtx2[0:iN][0:gs3])
      for (int j=0;j<gs;j++)
      {
        float Rn1a = grid1[6*j+3]+1.e-20f; float Rn1b = grid2[6*j+3]+1.e-20f;
        float ne1 = Z1/Rn1a;
        float ne2 = Z1/Rn1b;
     ...
     //2 basis on diff centers, then 1 nucleus elsewhere
      ...
      if (p!=m && p!=n)
      {
       ...
       #pragma acc parallel loop present(grid1[0:gs6],grid2[0:gs6],grid3[0:gs6],valt1[0:iN][0:gs],valt2[0:iN][0:gs],valS5[0:iN][0:gs],valtx1[0:iN][0:gs3],valtx2[0:iN][0:gs3],valS5x[0:iN][0:gs3])
        for (int j=0;j<gs;j++)
        {
          //float Rn1 = grid1p[6*j+3]+1.e-20f; float Rn2 = grid2p[6*j+3]+1.e-20f; float Rn3 = grid3p[6*j+3]+1.e-20f;
...
#endif
{
 ...
 //intermediate storage
  ...
  float** valT1 = new float*[iN]; for (int i=0;i<iN;i++) valT1[i] = new float[gs];
  float** valT2 = new float*[iN]; for (int i=0;i<iN;i++) valT2[i] = new float[gs];
  float** valT1x = new float*[iN]; for (int i=0;i<iN;i++) valT1x[i] = new float[gs3];
  float** valT2x = new float*[iN]; for (int i=0;i<iN;i++) valT2x[i] = new float[gs3];

  float* valt = new float[gs3];
...
#endif
{
 ...
 //intermediate storage
  ...
  for (int i=0;i<iN;i++) val1[i] = new float[gs];
  for (int i=0;i<iN;i++) val2[i] = new float[gs];
  for (int i=0;i<iN;i++) val3[i] = new float[gs];
  for (int i=0;i<iN;i++) val4[i] = new float[gs];
  float** val1x = new float*[iN];
  float** val2x = new float*[iN];
  float** val3x = new float*[iN];
  float** val4x = new float*[iN];
  for (int i=0;i<iN;i++) val1x[i] = new float[gs3];
  for (int i=0;i<iN;i++) val2x[i] = new float[gs3];
  for (int i=0;i<iN;i++) val3x[i] = new float[gs3];
  for (int i=0;i<iN;i++) val4x[i] = new float[gs3];
  float* valt = new float[gs3];
  float* wtt1 = new float[gs];
