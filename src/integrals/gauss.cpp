...
void eval_pd_gh(int gs, double* grid, double* val, int n1, int l1, int m1, double norm1, double zeta1)
{
  ...
  {
    printf("\n ERROR: cannot eval_pd_gh for l1>4 \n");
  }
...
void eval_p_gh(int gs, float* grid, float* val, int n1, int l1, int m1, float norm1, float zeta1)
{
  ...
  else if (l1==2)
  {
    ...
    for (int i=0;i<gs;i++)
    {
      ...
      float g1 = expf(-zeta1*r2);
      float rp = powf(r2,ntm);
      float v1 = -2.f-nlm+2.f*zeta1*x2y2;
      float v2 = 1.f-nlm+zeta1*x2y2;
      float v3 = 4.f-nlm+2.f*zeta1*x2y2;
      float v4 = 2.f+nlm-zeta1*x2y2;

      val[3*i+0] = g1*rp*(x2y2*v1 - 2.f*v2*z2 - fz*z4)*x;
      val[3*i+1] = g1*rp*(x2y2*v1 - 2.f*v2*z2 - fz*z4)*y;
      val[3*i+2] = g1*rp*(x2y2*v3 + 2.f*v4*z2 - fz*z4)*z;
    }
    else if (m1==1) //xz
    #pragma acc parallel loop present(grid[0:6*gs],val[0:gs3])
    for (int i=0;i<gs;i++)
    ...
    for (int i=0;i<gs;i++)
    {
      ...
      float rp = powf(r2,ntm);
      float y2z2 = y2+z2;
      float v0 = 2.+nlm-tz*z2;
      float v1 = 2.-nlm+tz*y2z2;

      val[3*i+0] = g1*rp*(-tz*x2*x2 + 2.f*z2 + x2*v0 + y2*v1)*x;
      val[3*i+1] = g1*rp*(-tz*x2*x2 - 2.f*z2 + x2*(v0-4.f) + y2*(v1-4.f))*y;
      val[3*i+2] = g1*rp*(nlm-tz*r2)*(x-y)*(x+y)*z;
    }
  }
  else if (l1==3)
  {
    ...
    for (int i=0;i<gs;i++)
    {
      ...
      val[3*i+0] = g1*rp*x*y*(-sz*x4 + 6.f*z2 + x2*(6.f + 3.f*nlm - fz*y2 - sz*z2) +  y2*(6.f - nlm + tz*(y2 + z2)));
      val[3*i+1] = g1*rp*(tz*y2*y4 + x4*(3.f - sz*y2) - 3.f*y2*z2 - y4*(3.f + nlm - tz*z2) + x2*(3.f*z2 + y2*(3.f*nlm - fz*y2 - sz*z2)));
      val[3*i+2] = g1*rp*y*(-3.f*x2 + y2)*z*(-nlm + tz*r2);
      //val[3*i+0] = g1*rp*(-sz*x4 + 6.*z2 + x2*(6. + 3.*nlm - fz*y2 - sz*z2) + y2*(6. - nlm + tz*(y2+z2)))*x*y;
      //val[3*i+1] = g1*rp*(tz*y2*y4 + x4*(3. - sz*y2) - 3.*y2*z2 - y4*(3. + nlm - tz*z2) + x2*(3.*z2 + y2*(3.*nlm - fz*y2 - sz*z2)));
      //val[3*i+2] = g1*rp*y*(-3.*x2 + y2)*z*(-nlm + tz*r2)*y*z;
    }
    ...
    for (int i=0;i<gs;i++)
    {
      ...
      val[3*i+0] = g1*rp*(3.f*x2y2*(-2.f - nlm + tz*x2y2) + 2.f*(-3.f + nlm + zeta1*x2y2)*z2 - fz*z4)*x*z;
      val[3*i+1] = g1*rp*(3.f*x2y2*(-2.f - nlm + tz*x2y2) + 2.f*(-3.f + nlm + zeta1*x2y2)*z2 - fz*z4)*y*z;
      val[3*i+2] = g1*rp*(-3.f*x2y2*x2y2 + 3.f*x2y2*(1.f - nlm + tz*x2y2)*z2 + 2.f*(3.f + nlm + zeta1*x2y2)*z4 - fz*z4*z2);
    }
    else if (m1==1) //(4z2-x2-y2)x
    #pragma acc parallel loop present(grid[0:6*gs],val[0:gs3])
    for (int i=0;i<gs;i++)
    ...
    for (int i=0;i<gs;i++)
    {
      ...
      val[3*i+0] = g1*rp*(-tz*x4 + 2.f*z2 + x2*(2.f + nlm - tz*z2) +  y2*(2.f - nlm + tz*y2z2))*x*z;
      val[3*i+1] = g1*rp*(-tz*x4 - 2.f*z2 + x2*(-2.f + nlm - tz*z2) +  y2*(-2.f - nlm + tz*y2z2))*y*z;
      val[3*i+2] = g1*rp*(x-y)*(x+y)*(-x2 - y2 - (1.f + nlm - tz*x2y2)*z2 + tz*z4);
    }
    else if (m1==3) //(x2-3y2)x
    #pragma acc parallel loop present(grid[0:6*gs],val[0:gs3])
    for (int i=0;i<gs;i++)
    {
      ...
      val[3*i+0] = g1*rp*(-tz*x4*x2 - 3.f*y2*y2z2 + x4*(3.f + nlm + fz*y2 - tz*z2) + 3.f*x2*(z2 + y2*(-nlm + tz*y2z2)));
      val[3*i+1] = g1*rp*(-tz*x4 + sz*y4 - 6.f*z2 - 3.f*y2*(2.f + nlm - tz*z2) + x2*(-6.f + nlm + fz*y2 - tz*z2))*x*y;
      val[3*i+2] = g1*rp*x*(x2 - 3.f*y2)*z*(nlm - tz*r2);
    }
  }
  else if (l1==4)
  {
    ...
    for (int i=0;i<gs;i++)
    {
      ...
      val[3*i+0] = g1*rp*y*(-tz*x4*x2 - y2*(y2 + z2) + x4*(3.f + nlm - tz*z2) +  x2*(3.f*z2 + y2*(2.f - nlm + tz*(y2 + z2))));
      val[3*i+1] = g1*rp*x*(tz*y4*y2 + x4*(1.f - tz*y2) - 3.f*y2*z2 - y4*(3.f + nlm - tz*z2) + x2*(z2 + y2*(-2.f + nlm - tz*z2)));
      val[3*i+2] = g1*rp*x*(x-y)*y*(x+y)*z*(nlm - tz*r2);
    }
    else if (m1==-3) //y*z * (3.*x*x - y*y)
    #pragma acc parallel loop present(grid[0:6*gs],val[0:gs3])
    for (int i=0;i<gs;i++)
    {
      ...
      val[3*i+0] = g1*rp*x*y*z*(-sz*x4 + tz*y4 + 6.f*z2 + x2*(6.f + 3.f*nlm - fz*y2 - sz*z2) + y2*(6.f - nlm + tz*z2));
      val[3*i+1] = g1*rp*z*(tz*y4*y2 + x4*(3.f - sz*y2) - 3.f*y2*z2 +  y4*(-3.f - nlm + tz*z2) +  x2*(3.f*z2 + y2*(3.f*nlm - fz*y2 - sz*z2)));
      val[3*i+2] = g1*rp*y*(x4*(3.f - sz*z2) + x2*(2.f*y2 + (3.f + 3.f*nlm - fz*y2)*z2 - sz*z4) + y2*(-y2 + (-1.f - nlm + tz*y2)*z2 + tz*z4));
    }
    else if (m1==-2) //x*y * (6.*z*z - x*x - y*y)
    #pragma acc parallel loop present(grid[0:6*gs],val[0:gs3])
    for (int i=0;i<gs;i++)
    {
      ...
      val[3*i+0] = g1*rp*2.f*y*(zeta1*x4*x2 - 0.5f*y4 + 2.5*y2*z2 + 3.f*z4 + x4*(-1.5f - 0.5f*nlm + tz*y2 - iz*z2) + x2*(zeta1*y4 + z2*(1.5f + 3.f*nlm - sz*z2) +  y2*(-2.f - 0.5f*nlm - iz*z2)));
      val[3*i+1] = g1*rp*2.f*x*(zeta1*y4*y2 + x4*(-0.5f + zeta1*y2) + 3.f*z4 + y2*z2*(1.5f + 3.f*nlm - sz*z2) + y4*(-1.5f - 0.5f*nlm - iz*z2) +  x2*(tz*y4 + 2.5f*z2 + y2*(-2.f - 0.5f*nlm - iz*z2)));
      val[3*i+2] = g1*rp*2.f*x*y*z*(zeta1*x4 + zeta1*y4 + z2*(6.f + 3.f*nlm - sz*z2) +  y2*(6.f - 0.5f*nlm - iz*z2) + x2*(6.f - 0.5f*nlm + tz*y2 - iz*z2));
    }
    else if (m1==-1) //y*z * (4.*z*z - 3.*x*x - 3.*y*y)
    #pragma acc parallel loop present(grid[0:6*gs],val[0:gs3])
    for (int i=0;i<gs;i++)
...
void eval_ghd(int gs, double* grid, double* val1, int l1, int m1, const double norm1, const double zeta1)
{
 ...
 //especially l1>=3
  ...
  if (l1==1)
  {
   //this ordering differs from the Slater basis
   // and instead follow that of doi: 10.1063/5.0200293
    if (m1==-1)      //px
    {
     #pragma acc parallel loop present(grid[0:6*gs],val1[0:gs])
      for (int i=0;i<gs;i++)
 ...
 //not tested
  else if (l1==4)
  {
    ...
    else if (m1==-3)      //g y*z * (3.*x*x - y*y)
    {
     #pragma acc parallel loop present(grid[0:6*gs],val1[0:gs])
      for (int i=0;i<gs;i++)
      {
        ...
        double y = grid[6*i+1];
        double z = grid[6*i+2];
        val1[i] *= y*z * (3.*x*x - y*y);
      }
    }
    else if (m1==-2)      //g x*y * (6.*z*z - x*x - y*y)
    {
     #pragma acc parallel loop present(grid[0:6*gs],val1[0:gs])
      for (int i=0;i<gs;i++)
      {
        ...
        double y = grid[6*i+1];
        double z = grid[6*i+2];
        val1[i] *= x*y * (6.*z*z - x*x - y*y);
      }
    }
    else if (m1==-1)      //g y*z * (4.*z*z - 3.*x*x - 3.*y*y)
    {
     #pragma acc parallel loop present(grid[0:6*gs],val1[0:gs])
      for (int i=0;i<gs;i++)
      {
    ...
    else if (m1==1)       //g x*z * (4.*z*z - 3.*x*x - 3.*y*y)
    {
     #pragma acc parallel loop present(grid[0:6*gs],val1[0:gs])
      for (int i=0;i<gs;i++)
      {
        ...
        double y = grid[6*i+1];
        double z = grid[6*i+2];
        val1[i] *= x*z * (4.*z*z - 3.*x*x - 3.*y*y);
      }
    }
    else if (m1==2)       //g (x2 - y2) * (6.*z*z - x2 - y2)
    {
     #pragma acc parallel loop present(grid[0:6*gs],val1[0:gs])
      for (int i=0;i<gs;i++)
      {
        ...
        double x2 = x*x;
        double y2 = y*y;
        val1[i] *= (x2 - y2) * (6.*z*z - x2 - y2);
      }
    }
    else if (m1==3)       //g x*z * (x*x - 3.*y*y)
    {
     #pragma acc parallel loop present(grid[0:6*gs],val1[0:gs])
      for (int i=0;i<gs;i++)
      {
        ...
        double y = grid[6*i+1];
        double z = grid[6*i+2];
        val1[i] *= x*z * (x*x - 3.*y*y);
      }
    }
    else if (m1==4)       //g (x2 * (x2 - 3.*y2) - y2 * (3.*x2 - y2))
    {
     #pragma acc parallel loop present(grid[0:6*gs],val1[0:gs])
      for (int i=0;i<gs;i++)
      {
 ...
 //should have same order as libcint now
  ...
  {
    if (m1==-5)      //h (5.*x2*x2 - 10.*x2*y2 + y2*y2)*y
    {
     #pragma acc parallel loop present(grid[0:6*gs],val1[0:gs])
      for (int i=0;i<gs;i++)
      {
   ...
   //ordering differed (lower should be +5)
    else if (m1==-3)      //h (x2*x2 - 10.*x2*y2 + 5.*y2*y2)*x
    {
     #pragma acc parallel loop present(grid[0:6*gs],val1[0:gs])
      for (int i=0;i<gs;i++)
      {
   ...
   //ordering differed (lower should be +2)
    else if (m1==-2)      //h y * (y2-3.*x2)*(x2 + y2 - 8.*z2)
    {
     #pragma acc parallel loop present(grid[0:6*gs],val1[0:gs])
      for (int i=0;i<gs;i++)
      {
        ...
        double z2 = z*z;
        double r2 = r*r;
        val1[i] *= x*y*z*(3.*z2-r2);
        //val1[i] *= y * (y2-3.*x2)*(x2 + y2 - 8.*z2);
      }
    }
   //ordering differed (lower should be +4)
    else if (m1==-1)      //h z * (x2*x2 - 6.*x2*y2 + y2*y2)
    {
     #pragma acc parallel loop present(grid[0:6*gs],val1[0:gs])
      for (int i=0;i<gs;i++)
      {
   ...
   //ordering differed (lower should be -2)
    else if (m1==0)      //h (x2 + y2 - 2.*z2)*x*y*z
    {
     #pragma acc parallel loop present(grid[0:6*gs],val1[0:gs])
      for (int i=0;i<gs;i++)
      {
        ...
        double z2 = z*z;
        double r2 = r*r;
        val1[i] *= z*(15.*r2*r2 - 70.*r2*z2 + 63.*z2*z2);
        //val1[i] *= (x2 + y2 - 2.*z2)*x*y*z;
      }
    }
   //ordering differed (lower should be +3??)
    else if (m1==1)      //h x * (x2-3.*y2)*(x2 + y2 - 8.*z2)
    {
     #pragma acc parallel loop present(grid[0:6*gs],val1[0:gs])
      for (int i=0;i<gs;i++)
      {
   ...
   //ordering differed (lower should be ??)
    else if (m1==2)      //h y * (x2*x2 + y2*y2 - 12.*y2*z2 + 8.*z2*z2 + 2.*x2 * (y2-6.*z2))
    {
     #pragma acc parallel loop present(grid[0:6*gs],val1[0:gs])
      for (int i=0;i<gs;i++)
      {
   ...
   //ordering differed (lower should be +2)
    else if (m1==3)      //h (x2 - y2) * (x2 + y2 - 2.*z2) * z
    {
     #pragma acc parallel loop present(grid[0:6*gs],val1[0:gs])
      for (int i=0;i<gs;i++)
      {
   ...
   //ordering differ (lower should be ??)
    else if (m1==4)      //h z * (15.*x2*x2 + 15.*y2*y2 - 40.*y2*z2 + 8.*z2*z2 + 10.*x2 * (3.*y2 - 4.*z2))
    {
     #pragma acc parallel loop present(grid[0:6*gs],val1[0:gs])
      for (int i=0;i<gs;i++)
      {
        ...
        double y2 = y*y;
        val1[i] *= z * (x2*x2 - 6.*x2*y2 + y2*y2);
        //val1[i] *= z * (15.*x2*x2 + 15.*y2*y2 - 40.*y2*z2 + 8.*z2*z2 + 10.*x2 * (3.*y2 - 4.*z2));
      }
    }
   //ordering differed (lower should be ??)
    else if (m1==5)      //h x * (x2*x2 + y2*y2 - 12.*y2*z2 + 8.*z2*z2 + 2.*x2* (y2 - 6.*z2))
    {
     #pragma acc parallel loop present(grid[0:6*gs],val1[0:gs])
      for (int i=0;i<gs;i++)
      {
    ...
    if (m1==-6)      //i xy (-3x4 + 10x2y2 - 3y4)
    {
     #pragma acc parallel loop present(grid[0:6*gs],val1[0:gs])
      for (int i=0;i<gs;i++)
      {
        ...
        val1[i] *= x*y*(10.*x2*y2 - 3.*x2*x2 - 3.*y2*y2);
      }
    }
    else if (m1==-5)      //i yz (-5x4 + 10x2y2-y4)
    {
     #pragma acc parallel loop present(grid[0:6*gs],val1[0:gs])
      for (int i=0;i<gs;i++)
      {
        ...
        val1[i] *= y*z * (10.*x2*y2 - 5.*x2*x2 - y2*y2);
      }
    }
    else if (m1==-4)      //i xy (r2(x2-y2) + 11z2(y2-x2))
    {
    ...
    else if (m1==-2)      //i y (-r4 + 18r2z2 - 33z4)
    {
     #pragma acc parallel loop present(grid[0:6*gs],val1[0:gs])
      for (int i=0;i<gs;i++)
      {
        ...
        val1[i] *= y * (18.*r2*z2 - r2*r2 - 33.*z2*z2);
      }
    }
    else if (m1==-1)      //i yz (-5r4 + 30r2z2 - 33z4)
    {
     #pragma acc parallel loop present(grid[0:6*gs],val1[0:gs])
      for (int i=0;i<gs;i++)
      {
        ...
        val1[i] *= y*z * (30.*r2*z2 - 5.*r2*r2 - 33.*z2*z2);
      }
    }
    else if (m1==0)      //i (-5r6 + 105r4z2 - 315r2z4 + 231z6)
    {
     #pragma acc parallel loop present(grid[0:6*gs],val1[0:gs])
      for (int i=0;i<gs;i++)
      {
        ...
        val1[i] *= 105.*r4*z2 - 5.*r2*r4 - 315.*r2*z4 + 231.*z4*z2;
      }
    }
    else if (m1==1)      //i xz (-5r4 + 30r2z2 - 33z4)
    {
     #pragma acc parallel loop present(grid[0:6*gs],val1[0:gs])
      for (int i=0;i<gs;i++)
      {
        ...
        val1[i] *= x*z * (30.*r2*z2 - 5.*r2*r2 - 33.*z2*z2);
      }
    }
    else if (m1==2)      //i x (r4 - 18r2z2 + 33z4)
    {
     #pragma acc parallel loop present(grid[0:6*gs],val1[0:gs])
      for (int i=0;i<gs;i++)
      {
        ...
        val1[i] *= x * (r2*r2 - 18.*r2*z2 + 33.*z2*z2);
      }
    }
    else if (m1==3)      //i xz (3r2(x2-3y2) + 11z2(-x2+3y2))
    {
    ...
    else if (m1==4)      //i (r2(6x2y2-x4-y4) + 11z2(x4-6x2y2+y4))
    {
     #pragma acc parallel loop present(grid[0:6*gs],val1[0:gs])
      for (int i=0;i<gs;i++)
      {
        ...
        val1[i] *= (r2-11.*z2)*(6.*x2*y2-x2*x2-y2*y2);
      }
    }
    else if (m1==5)      //i xz (10x2y2-x4-5y4)
    {
     #pragma acc parallel loop present(grid[0:6*gs],val1[0:gs])
      for (int i=0;i<gs;i++)
      {
        ...
        val1[i] *= x*z * (10.*x2*y2-x2*x2-5.*y2*y2);
      }
    }
    else if (m1==6)      //i (x6 -15x4y2 + 15x2y4 - y6)
    {
     #pragma acc parallel loop present(grid[0:6*gs],val1[0:gs])
      for (int i=0;i<gs;i++)
      {
        ...
        val1[i] *= x4*x2 + 15.*x2*(y4-x2*y2) - y4*y2;
      }
    }
  }
