...
void generate_ps_quad_grid(int tid, int wb, int nb, double Z1, int natoms, double* coordn, int quad_order, int quad_r_order, int nmu, int nnu, int nphi, double* grid, double* wt);
...
void initialize_ps_coords_2c(int tid, double a, double cf, int nmu, int nnu, int nphi, double phi0, double* grid, double* gridm, double* wt, int prl);
void initialize_ps_coords_3c(int tid, double cf, int nmu, int nnu, int nphi, double phi0, double* coordn, double* grid, double* gridm, double* wt, double* rot, int prl);
void initialize_ps_coords_batch(int tid, int wb, int nbatch, double a, double cf, int nmu, int nnu, int nphi, double phi0, double* grid, double* gridm, double* wt, int prl);
